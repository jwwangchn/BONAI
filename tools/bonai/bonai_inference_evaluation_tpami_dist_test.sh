...
./tools/bonai/bonai_dist_test.sh configs/tpami/${model}.py work_dirs/${model}/${epoch}.pth 4 --out ${root}/${model}_${city}_coco_results.pkl --city ${city} --options jsonfile_prefix=${root}/${model} segmentation_eval=False
